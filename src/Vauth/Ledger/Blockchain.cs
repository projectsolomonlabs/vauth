...
namespace Vauth.Ledger
{
    ...
    public sealed partial class Blockchain : UntypedActor
    {
        ...
        /// </summary>
        /// <param name="system">The <see cref="VauthSystem"/> object that contains the <see cref="Blockchain"/>.</param>
        public Blockchain(VauthSystem system)
        {
            this.system = system;
        }
        ...
        public static Props Props(VauthSystem system)
        {
        ...
        private static ImmutableHashSet<UInt160> UpdateExtensibleWitnessWhiteList(ProtocolSettings settings, DataCache snapshot)
        {
            ...
            builder.Add(NativeContract.Vauth.GetCommitteeAddress(snapshot));
            var validators = NativeContract.Vauth.GetNextBlockValidators(snapshot, settings.ValidatorsCount);
