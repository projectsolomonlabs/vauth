...
namespace Vauth.Ledger
{
    ...
    public class MemoryPool : IReadOnlyCollection<Transaction>
    {
        ...
        private readonly VauthSystem _system;
        ...
        /// </summary>
        /// <param name="system">The <see cref="VauthSystem"/> object that contains the <see cref="MemoryPool"/>.</param>
        public MemoryPool(VauthSystem system)
        {
            _system = system;
