        ...
        private void OnStart(ChannelsConfig config)
        {
                ...
                && UPnP.Discover())
            {
                try
                {
                    ...
                    if (ListenerTcpPort > 0) UPnP.ForwardPort(ListenerTcpPort, ProtocolType.Tcp, "Vauth Tcp");
                    if (ListenerWsPort > 0) UPnP.ForwardPort(ListenerWsPort, ProtocolType.Tcp, "Vauth WebSocket");
                }
                catch { }
            }
