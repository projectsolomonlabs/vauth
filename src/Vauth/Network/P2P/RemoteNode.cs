...
{
    /// <summary>
    /// Represents a connection of the Vauth network.
    /// </summary>
    public partial class RemoteNode : Connection
    {
        ...
        /// </summary>
        /// <param name="system">The <see cref="VauthSystem"/> object that contains the <paramref name="localNode"/>.</param>
        ...
        public RemoteNode(VauthSystem system, LocalNode localNode, object connection, IPEndPoint remote, IPEndPoint local)
        ...
        internal static Props Props(VauthSystem system, LocalNode localNode, object connection, IPEndPoint remote, IPEndPoint local)
        {
