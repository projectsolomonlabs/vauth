...
namespace Vauth.Plugins
{
    ...
    public abstract class Plugin : IDisposable
    {
        ...
        /// <summary>
        /// Called when a <see cref="VauthSystem"/> is loaded.
        /// </summary>
        /// <param name="system">The loaded <see cref="VauthSystem"/>.</param>
        internal protected virtual void OnSystemLoaded(VauthSystem system)
        {
        }
