...
{
    /// <summary>
    /// Represents the protocol settings of the Vauth system.
    /// </summary>
    public record ProtocolSettings
    {
        /// <summary>
        /// The magic number of the Vauth network.
        /// </summary>
        public uint Network { get; init; }

        /// <summary>
        /// The address version of the Vauth system.
        /// </summary>
        ...
        /// <summary>
        /// The number of members of the committee in Vauth system.
        /// </summary>
        public int CommitteeMembersCount => StandbyCommittee.Count;

        /// <summary>
        /// The number of the validators in Vauth system.
        /// </summary>
        ...
        /// <summary>
        /// The default protocol settings for Vauth MainNet.
        /// </summary>
        public static ProtocolSettings Default { get; } = new ProtocolSettings
        {
            ...
            NativeUpdateHistory = new Dictionary<string, uint[]>
            {
                ...
                [nameof(VauthToken)] = new[] { 0u },
                [nameof(ValtToken)] = new[] { 0u },
