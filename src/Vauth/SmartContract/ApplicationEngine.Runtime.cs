...
namespace Vauth.SmartContract
{
    partial class ApplicationEngine
    {
        ...
        /// <summary>
        /// The <see cref="InteropDescriptor"/> of System.Runtime.ValtLeft.
        /// Gets the remaining VALT that can be spent in order to complete the execution.
        /// </summary>
        public static readonly InteropDescriptor System_Runtime_ValtLeft = Register("System.Runtime.ValtLeft", nameof(ValtLeft), 1 << 4, CallFlags.None);

        /// <summary>
        /// The <see cref="InteropDescriptor"/> of System.Runtime.BurnValt.
        /// Burning VALT to benefit the Vauth ecosystem.
        /// </summary>
        public static readonly InteropDescriptor System_Runtime_BurnValt = Register("System.Runtime.BurnValt", nameof(BurnValt), 1 << 4, CallFlags.None);

        /// <summary>
        /// The implementation of System.Runtime.Platform.
        /// Gets the name of the current platform.
        /// </summary>
        /// <returns>It always returns "Vauth".</returns>
        ...
        /// <summary>
        /// The implementation of System.Runtime.BurnValt.
        /// Burning VALT to benefit the Vauth ecosystem.
        /// </summary>
        /// <param name="valt">The amount of VALT to burn.</param>
        protected internal void BurnValt(long valt)
        {
            if (valt <= 0)
                throw new InvalidOperationException("VALT must be positive.");
            AddValt(valt);
        }
    }
}
