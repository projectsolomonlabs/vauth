...
{
    /// <summary>
    /// Represents the basic unit that contains all the components required for running of a Vauth node.
    /// </summary>
    public class VauthSystem : IDisposable
    {
        /// <summary>
        /// Triggered when a service is added to the <see cref="VauthSystem"/>.
        /// </summary>
        public event EventHandler<object> ServiceAdded;

        /// <summary>
        /// The protocol settings of the <see cref="VauthSystem"/>.
        /// </summary>
        public ProtocolSettings Settings { get; }

        /// <summary>
        /// The <see cref="Akka.Actor.ActorSystem"/> used to create actors for the <see cref="VauthSystem"/>.
        /// </summary>
        public ActorSystem ActorSystem { get; } = ActorSystem.Create(nameof(VauthSystem),
        ...
        /// <summary>
        /// The genesis block of the Vauth blockchain.
        /// </summary>
        public Block GenesisBlock { get; }

        /// <summary>
        /// The <see cref="Ledger.Blockchain"/> actor of the <see cref="VauthSystem"/>.
        /// </summary>
        public IActorRef Blockchain { get; }

        /// <summary>
        /// The <see cref="Network.P2P.LocalNode"/> actor of the <see cref="VauthSystem"/>.
        /// </summary>
        public IActorRef LocalNode { get; }

        /// <summary>
        /// The <see cref="Network.P2P.TaskManager"/> actor of the <see cref="VauthSystem"/>.
        /// </summary>
        public IActorRef TaskManager { get; }

        /// <summary>
        /// The transaction router actor of the <see cref="VauthSystem"/>.
        /// </summary>
        ...
        /// <summary>
        /// The memory pool of the <see cref="VauthSystem"/>.
        /// </summary>
        public MemoryPool MemPool { get; }

        /// <summary>
        /// The header cache of the <see cref="VauthSystem"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VauthSystem"/> class.
        /// </summary>
        /// <param name="settings">The protocol settings of the <see cref="VauthSystem"/>.</param>
        ...
        public VauthSystem(ProtocolSettings settings, string storageEngine = null, string storagePath = null)
        {
        ...
        /// <summary>
        /// Creates the genesis block for the Vauth blockchain.
        /// </summary>
        /// <param name="settings">The <see cref="ProtocolSettings"/> of the Vauth system.</param>
        ...
        /// <summary>
        /// Adds a service to the <see cref="VauthSystem"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets a specified type of service object from the <see cref="VauthSystem"/>.
        /// </summary>
