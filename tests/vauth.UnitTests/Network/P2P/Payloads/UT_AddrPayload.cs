...
namespace Vauth.UnitTests.Network.P2P.Payloads
{
    ...
    public class UT_AddrPayload
    {
        ...
        public void Size_Get()
        {
            ...
            test = AddrPayload.Create(new NetworkAddressWithTime[] { new NetworkAddressWithTime() { Address = IPAddress.Any, Capabilities = new Vauth.Network.P2P.Capabilities.NodeCapability[0], Timestamp = 1 } });
