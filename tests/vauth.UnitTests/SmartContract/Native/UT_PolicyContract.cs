...
namespace Vauth.UnitTests.SmartContract.Native
{
    ...
    public class UT_PolicyContract
    {
        ...
        public void TestSetup()
        {
            ...
            ApplicationEngine engine = ApplicationEngine.Create(TriggerType.OnPersist, null, _snapshot, new Block { Header = new Header() }, settings: TestBlockchain.TheVauthSystem.Settings, valt: 0);
