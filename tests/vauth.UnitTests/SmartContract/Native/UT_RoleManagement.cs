...
namespace Vauth.UnitTests.SmartContract.Native
{
    ...
    public class UT_RoleManagement
    {
        ...
        public void TestSetAndGet()
        {
            ...
            UInt160 committeeMultiSigAddr = NativeContract.Vauth.GetCommitteeAddress(snapshot1);
            ECPoint[] validators = NativeContract.Vauth.ComputeNextBlockValidators(snapshot1, ProtocolSettings.Default);
