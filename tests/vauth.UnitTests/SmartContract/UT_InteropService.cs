...
namespace Vauth.UnitTests.SmartContract
{
    ...
    public partial class UT_InteropService : TestKit
    {
        ...
        {
            ApplicationEngine.GetPlatform().Should().Be("Vauth");
        }
        ...
        private static ApplicationEngine GetEngine(bool hasContainer = false, bool hasSnapshot = false, bool hasBlock = false, bool addScript = true, long valt = 20_00000000)
        {
            ...
            ApplicationEngine engine = ApplicationEngine.Create(TriggerType.Application, tx, snapshot, block, TestBlockchain.TheVauthSystem.Settings, valt: valt);
