...
namespace Vauth.UnitTests.SmartContract
{
    ...
    public class UT_SmartContractHelper
    {
        ...
        public void TestIsMultiSigContract()
        {
            ...
            script4[^1] = 0x00;
            Assert.AreEqual(false, Vauth.SmartContract.Helper.IsMultiSigContract(script4, out _, out ECPoint[] p4));
            Assert.IsNull(p4);
        }
        ...
        public void TestIsSignatureContract()
        {
            ...
            Assert.AreEqual(true, Vauth.SmartContract.Helper.IsSignatureContract(script));
            script[0] = 0x22;
            Assert.AreEqual(false, Vauth.SmartContract.Helper.IsSignatureContract(script));
        }
        ...
        public void TestIsStandardContract()
        {
            ...
            Assert.AreEqual(true, Vauth.SmartContract.Helper.IsStandardContract(script1));
            ...
            Assert.AreEqual(true, Vauth.SmartContract.Helper.IsStandardContract(script2));
        }
        ...
        public void TestVerifyWitnesses()
        {
            ...
            Assert.AreEqual(false, Vauth.SmartContract.Helper.VerifyWitnesses(new Header() { PrevHash = index1 }, ProtocolSettings.Default, snapshot1, 100));
            ...
            Assert.AreEqual(false, Vauth.SmartContract.Helper.VerifyWitnesses(header2, ProtocolSettings.Default, snapshot2, 100));
            ...
            Assert.AreEqual(false, Vauth.SmartContract.Helper.VerifyWitnesses(header3, ProtocolSettings.Default, snapshot3, 100));
            ...
            Assert.AreEqual(true, Vauth.SmartContract.Helper.VerifyWitnesses(tx, ProtocolSettings.Default, snapshot3, 1000));
        }
