...
namespace Vauth.UnitTests
{
    ...
    public class UT_VerificationContract
    {
        ...
        public void TestGenerator()
        {
            ...
            {
                Script = Vauth.SmartContract.Contract.CreateSignatureRedeemScript(key.PublicKey),
        ...
        public void TestGetHashCode()
        {
            ...
            byte[] script = Vauth.SmartContract.Contract.CreateSignatureRedeemScript(key.PublicKey);
